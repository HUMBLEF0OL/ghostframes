...
function RtlContent() {
  return (
    <div className="space-y-3 rounded-xl border border-zinc-800 bg-zinc-900 p-5 light:border-zinc-200 light:bg-white">
      <h2 className="text-2xl font-bold text-white light:text-zinc-900">
        مرحبا بكم في عرض Ghostframes
      </h2>
      <p className="text-sm leading-relaxed text-zinc-400 light:text-zinc-600">
        هذا النص يستخدم تخطيط من اليمين إلى اليسار لاختبار تموضع عناصر الهيكل العظمي ومطابقة
        الاتجاه.
      </p>
      <p className="text-sm leading-relaxed text-zinc-400 light:text-zinc-600">
  ...
  return (
    <div className="app-surface guide-page">
      <main className="app-content guide-flow">
        ...
        <FeatureCard
          title="Controls"
          description="Toggle loading and click the data-no-skeleton button"
          badge="RTL Validation"
        >
          <div className="flex flex-wrap items-center gap-3">
            ...
            <p className="text-sm text-zinc-500 light:text-zinc-600">
              Click count:{" "}
              <span data-testid="rtl-noskel-count" className="font-mono">
                {clickCount}
              </span>
            </p>
          </div>
          ...
          <div className="mt-3 rounded-lg border border-zinc-800 bg-zinc-950 p-3 text-xs light:border-zinc-200 light:bg-zinc-50">
            <p
              data-testid="rtl-loading-status"
              className="font-semibold text-zinc-300 light:text-zinc-700"
            >
              {loading
        ...
        <FeatureCard
          title="RTL Target"
          description="Skeletonized content rendered in right-to-left mode"
        >
