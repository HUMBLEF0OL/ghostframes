  ...
  return (
    <div className="app-surface guide-page">
      <main className="app-content guide-flow">
        ...
        <FeatureCard
          title="Controls"
          description="Run a fresh stress-cycle measurement"
          badge="Performance"
        >
        ...
        <FeatureCard
          ...
          description="Actual measurement telemetry"
          badge="ms"
        >
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-lg border border-zinc-800 bg-zinc-950 p-3 text-sm light:border-zinc-300 light:bg-zinc-100">
              ...
              <p
                data-testid="stress-total-nodes"
                className="font-mono text-lg text-zinc-300 light:text-zinc-700"
              >
        ...
        <FeatureCard
          title="300-element target"
          description="High-density layout to stress measurement"
        >
          <AutoSkeleton
            loading={loading}
