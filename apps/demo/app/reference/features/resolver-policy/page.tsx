...
export default function ResolverPolicyFeaturePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <FeatureCard
        title="Policy Mode"
        description="Compare resolver behavior by mode"
        badge="onResolution"
      >
        <div className="space-y-4">
          ...
          <p
            data-testid="resolver-event-count"
            className="text-xs text-zinc-500 light:text-zinc-600"
          >
          ...
          <p
            data-testid="resolver-last-source"
            className="text-xs text-zinc-500 light:text-zinc-600"
          >
