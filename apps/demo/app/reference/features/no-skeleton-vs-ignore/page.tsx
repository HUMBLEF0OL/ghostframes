    ...
    >
      <header data-no-skeleton className="flex items-center justify-between gap-2">
        <h3 className="text-sm font-semibold text-white light:text-zinc-900">
          data-no-skeleton region
        </h3>
        <button className="rounded bg-indigo-600 px-2 py-1 text-xs font-medium text-white">
          Action
        </button>
      </header>
    ...
    <div className="space-y-6">
      <header>
        <h1 className="mb-2 text-4xl font-bold text-white light:text-zinc-900">
          data-no-skeleton vs data-skeleton-ignore
        </h1>
      ...
      <FeatureCard
        ...
        description="Switch loading to compare behavior"
        badge="comparison"
      >
        <InteractiveToggle
          label="Loading state"
      ...
      <FeatureCard
        ...
        description="Side-by-side semantics"
        badge="attributes"
      >
