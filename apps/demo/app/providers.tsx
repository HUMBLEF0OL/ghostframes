...
export function ClientProviders({ children }: { children: React.ReactNode }): React.ReactElement {
  ...
  useEffect(() => {
    ...
    const snapshot: TelemetrySnapshot = {
      ...
      ratios: {
        manifestHitRatio:
          windowManifestAttempts > 0 ? windowCounters.manifestHits / windowManifestAttempts : 0,
        invalidationRate:
          windowManifestAttempts > 0 ? windowCounters.invalidations / windowManifestAttempts : 0,
        fallbackRatio:
