...
import { asStructuralHash, type BlueprintNode, type ManifestEntry } from "@ghostframes/core";
    ...
    it("scores a complete blueprint with high quality", () => {
      const entry = createTestEntry({
        blueprint: {
          ...
          rootWidth: 300,
          rootHeight: 200,
          nodes: [createNode("n1", "div"), createNode("n2", "span")],
          generatedAt: Date.now(),
          source: "dynamic",
        },
      });
    ...
    it("accepts blueprints with score >= 0.90", () => {
      const goodEntry = createTestEntry({
        blueprint: {
          ...
          rootWidth: 400,
          rootHeight: 300,
          nodes: [createNode("n1", "div"), createNode("n2", "section"), createNode("n3", "header")],
          generatedAt: Date.now(),
          source: "dynamic",
        },
        quality: {
    ...
    it("uses default threshold of 0.88 if not specified", () => {
      const mediumEntry = createTestEntry({
        blueprint: {
          ...
          rootWidth: 300,
          rootHeight: 200,
          nodes: [createNode("n1", "div"), createNode("n2", "span"), createNode("n3", "section")],
          generatedAt: Date.now(),
          source: "dynamic",
        },
        quality: {
    ...
    it("handles threshold boundaries for 0.88 and 0.90", () => {
      const boundaryEntry = createTestEntry({
        blueprint: {
          ...
          rootWidth: 250,
          rootHeight: 180,
          nodes: [createNode("n1", "div"), createNode("n2", "div"), createNode("n3", "div")],
          generatedAt: Date.now(),
          source: "dynamic",
        },
        quality: {
    ...
    it("handles maximum warning penalties without score collapse", () => {
      const maxWarnEntry = createTestEntry({
        blueprint: {
          ...
          rootWidth: 300,
          rootHeight: 200,
          nodes: [createNode("n1", "div"), createNode("n2", "div")],
          generatedAt: Date.now(),
          source: "dynamic",
        },
        quality: {
