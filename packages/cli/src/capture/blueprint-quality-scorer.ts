...
export function scoreBlueprint(entry: ManifestEntry): number {
  ...
  const score = completeness * 0.35 + confidence * 0.4 + sizeScore * 0.15 + warningPenalty * 0.1;
        ...
        nodeCount === 0
          ...
          : nodeCount < 3
            ...
            : nodeCount < 10
              ...
              : "comprehensive",
      confidence:
        entry.quality.confidence < 0.5 ? "low" : entry.quality.confidence < 0.8 ? "medium" : "high",
      sizeAppropriateness:
